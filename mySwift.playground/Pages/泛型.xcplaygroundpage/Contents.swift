...
show(para: "xiaoming") //Hello xiaoming
show(para: 12) //Hello 12
...
//类似于 associatedtype的还有self关键字，代表了协议遵守着本身的类型, 适用于比较这类方法, 其必须传入另一个相同类型的参数才有意义:
protocol CanCompare{
