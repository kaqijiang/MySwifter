...
p2.setName(name: "sdsd", age: 22)
print(p2.description())

p2.setName(name: "wewewe", age: 22)
print(p2.description())
...
var p3 = Person3(age: 22, name: "wewewe")
p3.name = "sd"//常量存储属性初始化之后不允许被修改! 虽没报错,但是不允许,这一点在后面开发中挖掘验证!
