...
weak var weakP:Person2? = Person2(name: "we")
if let p = weakP{
    print(p)
}else{
    print(weakP as Any)
...
unowned var weakP3:Person3 = Person3(name: "we")
...
var p4:Person4? = Person4(name: "we")
...
var p5:Person5? = Person5(name: "we")
