...
//NSData *data = [NSData .dataWithContentsOfMappedFile:@"/Users/yourMacName/Desktop/1.txt"];
//NSLog("%@", data);

var data:NSData? = NSData(contentsOfFile: "/Users/yourMacName/Desktop/1.html") //测试地址, 换成你自己路径地址文件即可
//print(data as Any)
